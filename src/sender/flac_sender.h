...
public:
	FlacSender(dpp::discord_voice_client* const voiceclient, const unsigned char speed_percent, const F* const read_buffer);
...
private:
	...
	FLAC__StreamDecoderReadStatus read_callback(unsigned char* buffer, unsigned long* buffer_size) override;
