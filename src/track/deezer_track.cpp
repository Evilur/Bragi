...
void DeezerTrack::Play(dpp::discord_voice_client* const voiceclient, const unsigned char speed_percent) {
	...
	auto read_buffer = [this](unsigned char* buffer, unsigned long* buffer_size) {
		/* Set the chunk size */
