...
public:
	...
	void AsyncPlay(dpp::discord_voice_client* const voiceclient, const byte speed_percent);
...
protected:
	...
	virtual void Play(dpp::discord_voice_client* const voiceclient, const byte speed_percent) = 0;
